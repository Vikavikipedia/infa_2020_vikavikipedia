...
tree_surf_1 = pygame.Surface(SIZE, pygame.SRCALPHA)
X_TREE = 370
Y_TREE = 405
...
def rotate_leaf(size, coordinate, angle, color=GREEN):
    ...
    screen.blit(rotated_surf, rotated_surf.get_rect(center=leaf_ellipse.center))
...
trunk_rectangles = [(405, 283, 29, 89), (406, 172, 27, 99)]         # основание ствола
for trunk in trunk_rectangles:
    rect(tree_surf_1, GREEN, trunk, 0)
trunk_polygons = [((419, 162), (400, 155), (419, 99), (438, 105)),  # верх ствола
...
y_tree_2 = 382
x_tree = 404    # координаты ствола основной пальмы
y_tree = 368
tree_surf_2 = pygame.Surface(SIZE, pygame.SRCALPHA)
trunk_2 = pygame.transform.scale(tree_surf_1, (X * nx_2, Y * ny_2))
#leafs_2 = pygame.transform.scale(, (X * nx_2, Y * ny_2))
screen.blit(trunk_2, (x_tree_2 - x_tree * nx_2, y_tree_2 - y_tree * ny_2))
#screen.blit(rotated_surf, (x_tree_2 - x_tree * nx_2, y_tree_2 - y_tree * ny_2))
